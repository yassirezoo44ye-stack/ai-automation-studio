"""
Training Studio — idempotent schema initialisation.

Called once per startup from factory.py (async lifespan context).
...
async def init_training_schema(conn: asyncpg.Connection) -> None:
    """Create all Training Studio tables (idempotent — safe to call on every startup)."""
