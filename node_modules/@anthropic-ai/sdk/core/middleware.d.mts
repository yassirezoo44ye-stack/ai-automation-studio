...
import type { APIRequest } from "./api.mjs";
/**
 ...
 */
export declare function wrapFetchWithMiddleware(fetchFn: Fetch, middleware: readonly Middleware[], options?: FinalRequestOptions | undefined): Fetch;
/**
 * Composes `middleware` around `fetchFn` and returns the entry point of the chain.
 */
export declare function applyMiddleware(fetchFn: Fetch, middleware: readonly Middleware[], options?: FinalRequestOptions | undefined): MiddlewareNext;
